...
beta2ではダッシュボードの応答とログインの維持を改善し、アドレスのコピーボタン、OP_RETURN設定の説明、SSH管理者権限を追加しました。[変更点とダウンロード](https://github.com/dontrustjustverify/justverify/releases/tag/v0.1.0-beta2)。
